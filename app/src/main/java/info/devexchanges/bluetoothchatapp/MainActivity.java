        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_WRITE:
                    ...
                    boolean belongsToCurrentUser1 = true;
                    info.devexchanges.bluetoothchatapp.Message message1 = new info.devexchanges.bluetoothchatapp.Message(writeMessage, data1, belongsToCurrentUser1);
                ...
                case MESSAGE_READ:
                    ...
                    boolean belongsToCurrentUser2 = false;
                    Log.d("Bug", "handleMessage: " + readMessage);
                    info.devexchanges.bluetoothchatapp.Message message2 = new info.devexchanges.bluetoothchatapp.Message(readMessage, data2, belongsToCurrentUser2);
